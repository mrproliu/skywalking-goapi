...
func (c *satelliteAccessLogServiceClient) StreamAccessLogs(ctx context.Context, opts ...grpc.CallOption) (SatelliteAccessLogService_StreamAccessLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SatelliteAccessLogService_ServiceDesc.Streams[0], "/satellite.envoy.accesslog.v2.SatelliteAccessLogService/StreamAccessLogs", opts...)
	if err != nil {
		return nil, err
	}
...
type SatelliteAccessLogService_StreamAccessLogsClient interface {
	Send(*v2.StreamAccessLogsMessage) error
	CloseAndRecv() (*v2.StreamAccessLogsResponse, error)
	grpc.ClientStream
}
...
func (x *satelliteAccessLogServiceStreamAccessLogsClient) Send(m *v2.StreamAccessLogsMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *satelliteAccessLogServiceStreamAccessLogsClient) CloseAndRecv() (*v2.StreamAccessLogsResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(v2.StreamAccessLogsResponse)
...
type SatelliteAccessLogService_StreamAccessLogsServer interface {
	SendAndClose(*v2.StreamAccessLogsResponse) error
	Recv() (*v2.StreamAccessLogsMessage, error)
	grpc.ServerStream
}
...
func (x *satelliteAccessLogServiceStreamAccessLogsServer) SendAndClose(m *v2.StreamAccessLogsResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *satelliteAccessLogServiceStreamAccessLogsServer) Recv() (*v2.StreamAccessLogsMessage, error) {
...
var SatelliteAccessLogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "satellite.envoy.accesslog.v2.SatelliteAccessLogService",
	...
	Metadata: "satellite/alsv2.proto",
}
